...
//import common.HUD;
//
//public class CopyOfCaveGame implements ApplicationListener {
...
//		camera.setToOrtho(false, w / Globals.PIXELS_PER_METER, h / Globals.PIXELS_PER_METER);
//
...
//
//		playerlight = new PointLight(rayHandler, 11, new Color(1, 1, 1, 0.1f),
...
//
//		camera.setToOrtho(false, width / Globals.PIXELS_PER_METER, height
